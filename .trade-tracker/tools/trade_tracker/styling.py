...
.dashboard-section-supporting .section-summary {{
  padding: 14px 18px 10px;
}}

.dashboard-section-supporting .section-title {{
  font-size: 16px;
}}

.dashboard-section-supporting .section-note {{
  color: #7a857f;
  font-size: 12px;
  line-height: 1.42;
}}
...
.dashboard-top-refresh {{
  ...
  padding: 0 15px;
  white-space: nowrap;
  box-shadow: 0 8px 18px rgba(19, 115, 51, 0.16);
}}

.dashboard-top-refresh:hover,
.dashboard-top-refresh:focus-visible {{
  background: linear-gradient(135deg, #0f6b2d, #2f9b4d);
}}

.dashboard-top-refresh:focus-visible {{
  outline: 2px solid rgba(19, 115, 51, 0.22);
  outline-offset: 2px;
}}

.dashboard-top-refresh:disabled,
.dashboard-top-refresh.is-disabled {{
  background: #dfe8e2;
  color: #7a867d;
  box-shadow: none;
  cursor: not-allowed;
