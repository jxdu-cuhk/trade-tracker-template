...
class DashboardLayoutTests(unittest.TestCase):
    ...
    def test_apply_tonghuashun_curve_style_inserts_local_benchmark_shell(self):
        ...
        self.assertIn("data-curve-hero-value", updated)
        self.assertIn("data-curve-hero-rate", updated)
        ...
        self.assertIn("data-curve-money-toggle", updated)
        self.assertIn("ths-curve-privacy-toggle", updated)
        self.assertIn('data-curve-toggle="excess"', updated)
