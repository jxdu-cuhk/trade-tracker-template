...
class RealizedAnalysisTests(unittest.TestCase):
    ...
    def test_render_realized_section_has_calendar_and_custom_stage_dates(self):
        ...
        self.assertIn('data-display-payload', section)
        self.assertIn('data-realized-day-metrics', section)
        self.assertIn('data-realized-calendar-mode', section)
        ...
        self.assertIn("dayToneClassForValue", section)
        self.assertIn("pnl-day-positive", section)
        self.assertIn("pnl-day-negative", section)
        self.assertIn("curveChangeForDay", section)
        self.assertIn("currentHoldingDailyFloatCny", section)
        self.assertIn("displayPayload?.dailyPnl?.current", section)
        self.assertIn("realizedDailyByDate", section)
        self.assertIn("realizedDailyForDay", section)
        self.assertIn("DOMContentLoaded", section)
        self.assertIn("refreshCurveDataAndRender", section)
        self.assertIn("当日浮盈变动折", section)
        self.assertIn("当日总变动折", section)
